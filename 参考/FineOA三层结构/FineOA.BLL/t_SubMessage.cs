...
namespace FineOA.BLL
{
	...
	{
		private readonly It_SubMessage dal=DataAccess.Createt_SubMessage();
		public t_SubMessage()
		{}
		#region  BasicMethod
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public FineOA.Model.t_SubMessage GetModelByCache(int FItemId)
		{
			
			string CacheKey = "t_SubMessageModel-" + FItemId;
			...
			return (FineOA.Model.t_SubMessage)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<FineOA.Model.t_SubMessage> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<FineOA.Model.t_SubMessage> DataTableToList(DataTable dt)
		{
			List<FineOA.Model.t_SubMessage> modelList = new List<FineOA.Model.t_SubMessage>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				FineOA.Model.t_SubMessage model;
