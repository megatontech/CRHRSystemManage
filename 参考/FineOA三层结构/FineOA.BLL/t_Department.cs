...
namespace FineOA.BLL
{
	...
	public partial class t_Department
	{
		...
		{
			return dal.Exists(FParentId,FItemId);
		}
		...
		public bool Delete(int FParentId,int FItemId)
		{
			...
			return dal.Delete(FParentId,FItemId);
		}
		/// <summary>
		/// 删除一条数据
		/// </summary>
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public FineOA.Model.t_Department GetModelByCache(int FItemId)
		{
			
			string CacheKey = "t_DepartmentModel-" + FItemId;
			...
			return (FineOA.Model.t_Department)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<FineOA.Model.t_Department> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<FineOA.Model.t_Department> DataTableToList(DataTable dt)
		{
			List<FineOA.Model.t_Department> modelList = new List<FineOA.Model.t_Department>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				FineOA.Model.t_Department model;
