<%@ Page Language="C#" MasterPageFile="~/MasterPage/PageTemplate.Master" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="FrameWork.web.Module.FrameWork.EventManager._default"  %>
    ...
    <FrameWorkWebControls:TabOptionWebControls ID="TabOptionWebControls1" runat="server">
        <FrameWorkWebControls:TabOptionItem ID="TabOptionItem1" runat="server" Tab_Name="日志列表">
            <asp:GridView ID="GridView1" runat="server">
                <Columns>
                <asp:HyperLinkField HeaderText="ID" DataTextField="EventID" DataNavigateUrlFields="EventID" DataNavigateUrlFormatString="EventDisp.aspx?EventID={0}&CMD=Look" />
                ...
                <asp:BoundField HeaderText="时间" DataField="E_DateTime" />                
