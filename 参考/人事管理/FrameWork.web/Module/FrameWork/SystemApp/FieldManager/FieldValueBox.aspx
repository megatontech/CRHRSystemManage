<%@ Page Language="C#" MasterPageFile="~/MasterPage/PageTemplate.Master" AutoEventWireup="true" CodeBehind="FieldValueBox.aspx.cs" Inherits="FrameWork.web.Module.FrameWork.FieldManager.FieldValueBox"  %>
          ...
          <tr class="table_none">
            <td align="center">
                ...
                <tr>
                    ...
                    <td >
                       	<img border="0" src="<%=Page.ResolveUrl("~/") %>images/up01.gif" OnClick="javascript:moveUpDown('up','<%=OrderByListItems.ClientID %>');" style="cursor:pointer;">
    			        <p><img border="0" src="<%=Page.ResolveUrl("~/") %>images/down01.gif" OnClick="javascript:moveUpDown('down','<%=OrderByListItems.ClientID %>');" style="cursor:pointer;">
                    </td>
                </tr>
                </table>
