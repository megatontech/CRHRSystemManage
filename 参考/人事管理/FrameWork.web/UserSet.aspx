<%@ Page Language="C#" MasterPageFile="~/MasterPage/PageTemplate.Master" AutoEventWireup="true" CodeBehind="UserSet.aspx.cs" Inherits="FrameWork.web.UserSet"  %>
            ...
            <tr>
                ...
                <td class="table_none">
                    <asp:DropDownList ID="MenuSink" runat="server">
                        ...
                        <asp:ListItem Value="1">流行</asp:ListItem>
