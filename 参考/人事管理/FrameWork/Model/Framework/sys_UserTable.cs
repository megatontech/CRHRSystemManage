...
namespace FrameWork.Components
{
    ...
    public class sys_UserTable
    {
        ...
        private DateTime _U_BirthDay = DateTime.MaxValue; // 出生日期
        private string _U_MobileNo; //手机号
        private string _U_UserNO; //员工编号
        private DateTime _U_WorkStartDate = DateTime.MaxValue; // 到职日期
        private DateTime _U_WorkEndDate = DateTime.MaxValue; // 离职日期
