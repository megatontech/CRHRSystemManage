<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="group_panel.aspx.cs" Inherits="FineUIPro.Examples.window.group_panel" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Panel ID="Panel1" BodyPadding="5px" runat="server"
            ...
            <Items>
                <f:GroupPanel runat="server" Title="分组面板一" BodyPadding="5px" ID="GroupPanel1" EnableCollapse="True" Collapsed="true">
                    <Items>
