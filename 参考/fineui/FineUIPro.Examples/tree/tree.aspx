<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="tree.aspx.cs" Inherits="FineUIPro.Examples.tree.tree" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Tree ID="Tree1" Width="550px" ShowHeader="true" Title="树控件（内联）" EnableCollapse="true"
            runat="server">
            <Nodes>
