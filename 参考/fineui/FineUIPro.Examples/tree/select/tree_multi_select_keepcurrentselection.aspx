<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="tree_multi_select_keepcurrentselection.aspx.cs"
    Inherits="FineUIPro.Examples.tree.select.tree_multi_select_keepcurrentselection" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Tree ID="Tree1" Width="550px" EnableCollapse="true" ShowHeader="true" EnableMultiSelect="true" KeepCurrentSelection="true" Title="树控件"
            runat="server">
            <Nodes>
