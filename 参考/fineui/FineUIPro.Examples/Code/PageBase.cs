...
namespace FineUIPro.Examples
{
    public class PageBase : System.Web.UI.Page
    {
        ...
        {
            Notify(message, MessageBoxIcon.Information);
        }

        public void Notify(string message, MessageBoxIcon messageIcon)
        {
            Notify n = new Notify();
            n.Target = Target.Top;
            n.Message = message;
        ...
        protected DataTable GetFilteredTable(JArray filteredData)
        {
