<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="layout_checkout.aspx.cs"
    Inherits="FineUIPro.Examples.form.layout_checkout" %>
...
<body>
    <form id="_form1" runat="server">
        ...
        <f:Form ID="Form1" Width="650px" LabelAlign="Right" MessageTarget="Qtip" Title="账单信息"
                    ...
                    <Items>
                        ...
                        <f:Panel ID="Panel4" Layout="HBox" BoxConfigAlign="Stretch" CssClass="f-form-item" ShowHeader="false" ShowBorder="false" runat="server">
                            <Items>
                                ...
                                <f:TextBox ID="TextBox5" Label="市" Width="200px" LabelWidth="50px" Required="true" ShowRedStar="true" runat="server">
                                </f:TextBox>
                    ...
                    <Items>
                        ...
                        <f:Panel ID="Panel3" Layout="HBox" BoxConfigAlign="Stretch" CssClass="f-form-item" ShowHeader="false" ShowBorder="false" runat="server">
                            <Items>
                                ...
                                <f:TextBox ID="tbxBillingCity" Enabled="false" Label="市" Width="200px" LabelWidth="50px" Required="true" ShowRedStar="true" runat="server">
                                </f:TextBox>
                    ...
                    <Items>
                        ...
                        <f:Panel ID="Panel5" Layout="HBox" BoxConfigAlign="Stretch" CssClass="f-form-item" ShowHeader="false" ShowBorder="false" runat="server">
                            <Items>
                                ...
                                <f:DropDownList ID="DropDownList1" Label="过期时间" Width="200px" CssClass="marginr" LabelWidth="80px" Required="true" ShowRedStar="true" runat="server">
                                ...
                                <f:NumberBox ID="TextBox16" ShowLabel="false" Text="2014" Width="100px" LabelWidth="80px" Required="true" ShowRedStar="true" runat="server">
                                </f:NumberBox>
                            </Items>
                        </f:Panel>
                    </Items>
            ...
            <Toolbars>
                <f:Toolbar ID="Toolbar1" runat="server" ToolbarAlign="Right" Position="Bottom">
                    <Items>
                        <f:Button ID="Button1" IconFont="Save" Text="提交账单" ValidateForms="Form1" ValidateMessageBox="false" runat="server">
                        </f:Button>
                    </Items>
                </f:Toolbar>
            </Toolbars>
