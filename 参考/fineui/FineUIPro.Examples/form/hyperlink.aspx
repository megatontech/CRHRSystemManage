<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="hyperlink.aspx.cs" Inherits="FineUIPro.Examples.form.hyperlink" %>
...
<body>
    ...
    <br />
    <f:HyperLink ID="HyperLink2" Enabled="false" Text="点击弹出对话框" NavigateUrl="javascript:;" runat="server">
    </f:HyperLink>
    <br />
