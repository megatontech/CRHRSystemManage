<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="fileupload.aspx.cs" Inherits="FineUIPro.Examples.form.fileupload" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:SimpleForm ID="SimpleForm1" BodyPadding="5px" runat="server" Width="550px"  EnableCollapse="true"
            ...
            <Items>
                <f:TextBox runat="server" Label="用户名" ID="tbxUseraName" EmptyText="请输入用户名" Required="true" ShowRedStar="true">
                </f:TextBox>
