<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="layout_panel2.aspx.cs"
    Inherits="FineUIPro.Examples.form.layout_panel2" %>
...
<body>
    <form id="_form1" runat="server">
        ...
        <f:Form ID="Form1" MessageTarget="Qtip" Width="600px" BodyPadding="5px" Title="表单" runat="server">
            <items>
                <f:Panel ID="Panel2" ShowHeader="false" CssClass="" ShowBorder="false"
                ...
                <f:Panel ID="Panel1" ShowHeader="false" ShowBorder="false" Layout="Column" CssClass=""
                    runat="server">
                    <Items>
                ...
                <f:Panel ID="Panel3" ShowHeader="false" ShowBorder="false" Layout="Column" CssClass=""
                    runat="server">
                    <Items>
                ...
                <f:Panel ID="Panel4" ShowHeader="false" ShowBorder="false" Layout="Column" CssClass=""
                    runat="server">
                    <Items>
                        ...
                        <f:TextBox Width="40px" Required="true" ID="TextBox3" runat="server">
                        </f:TextBox>
                        <f:Label ID="Label6" runat="server" Text="&nbsp;分钟">
                        </f:Label>
                    </Items>
                </f:Panel>
