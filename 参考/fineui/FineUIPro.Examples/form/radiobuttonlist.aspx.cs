...
namespace FineUIPro.Examples.form
{
    public partial class radiobuttonlist : PageBase
    {
        ...
        protected void btnServerGetSelectedValue_Click(object sender, EventArgs e)
        {
            ...
            {
                Notify(String.Format("列表一选中项的值：{0}", RadioButtonList1.SelectedValue));
            }
            else
            {
        ...
        {
            Notify("列表三选中项的值：" + rblAutoPostBack.SelectedValue);
        }


        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            Notify("列表二选中项的值：" + RadioButtonList2.SelectedValue + "<br/>列表三选中项的值：" + rblAutoPostBack.SelectedValue + "<br/>列表四选中项的值：" + rblVertical.SelectedValue);
        }
