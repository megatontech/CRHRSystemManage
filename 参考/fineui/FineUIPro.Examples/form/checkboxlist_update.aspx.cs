...
namespace FineUIPro.Examples.form
{
    public partial class checkboxlist_update : PageBase
    {
        ...
        {
            Notify("列表一选中项的值：" + GetCheckedValuesString(CheckBoxList1.SelectedValueArray));
        }
        ...
        {
            Notify("列表二选中项的值：" + GetCheckedValuesString(CheckBoxList2.SelectedValueArray));
        }
        ...
        {
            Notify("列表三选中项的值：" + GetCheckedValuesString(CheckBoxList3.SelectedValueArray));
        }
        ...
        {
            Notify("列表四选中项的值：" + GetCheckedValuesString(CheckBoxList4.SelectedValueArray));
        }
