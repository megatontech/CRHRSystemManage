<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="column.aspx.cs" Inherits="FineUIPro.Examples.layout.column" %>
...
<body>
    <form id="form1" runat="server">
        ...
        ===========================================================================
        <br />
        <f:Panel ID="Panel23" runat="server" Width="850px" Height="350px" 
            AutoScroll="true" ShowBorder="True"  EnableCollapse="true"
