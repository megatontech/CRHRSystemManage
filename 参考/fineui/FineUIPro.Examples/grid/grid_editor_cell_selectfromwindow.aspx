<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="grid_editor_cell_selectfromwindow.aspx.cs"
    Inherits="FineUIPro.Examples.grid.grid_editor_cell_selectfromwindow" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="true" Title="表格（进入编辑状态后，从弹出窗体中选择用户）" 
            EnableCollapse="true" Width="850px" Height="350px"
            runat="server" DataKeyNames="Id,Name" AllowCellEditing="true" ShowSelectedCell="true" ClicksToEdit="1" 
        ...
        <f:Window ID="Window1" Hidden="true" EnableIFrame="true" EnableMaximize="true"
            ...
            Title="选择用户" OnClose="Window1_Close">
        </f:Window>
    </form>
    <script>
