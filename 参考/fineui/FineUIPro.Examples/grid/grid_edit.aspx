<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="grid_edit.aspx.cs" Inherits="FineUIPro.Examples.grid.grid_edit" %>
...
<body>
    ...
    <script type="text/javascript">
        ...
        function registerEnterEvent() {
            ...
            grid.el.on('keypress', inputselector, function (evt) {
                // Enter Key - 13
                if (evt.keyCode === 13) {
