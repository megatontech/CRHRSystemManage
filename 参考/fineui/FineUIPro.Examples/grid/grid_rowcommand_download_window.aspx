<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="grid_rowcommand_download_window.aspx.cs"
    Inherits="FineUIPro.Examples.grid.grid_rowcommand_download_window" %>
    ...
    <form id="form1" runat="server">
        ...
        <f:Grid ID="Grid1" Title="表格" EnableCollapse="true" ShowBorder="true" ShowHeader="true"
            ...
            <Columns>
                ...
                <f:LinkButtonField HeaderText="&nbsp;" Width="80px" CommandName="Action2" Text="下载" />
            </Columns>
        </f:Grid>
        <br />
