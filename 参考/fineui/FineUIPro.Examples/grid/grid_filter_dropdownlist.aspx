<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="grid_filter_dropdownlist.aspx.cs" Inherits="FineUIPro.Examples.grid.grid_filter_dropdownlist" %>
    ...
    <form id="form1" runat="server">
        ...
        <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="true" Title="表格" Width="800px" runat="server" EnableCollapse="true"
            ...
            <Columns>
                ...
                <f:TemplateField ColumnID="Gender" Width="80px" HeaderText="性别" EnableFilter="true">
                    <ItemTemplate>
                    ...
                    <Filter>
                        <Field>
                            <f:RadioButtonList Required="true" runat="server">
                ...
                <f:CheckBoxField ColumnID="AtSchool" Width="80px" RenderAsStaticField="true" DataField="AtSchool" HeaderText="是否在校" EnableFilter="true">
                    <Filter>
                        <Field>
                            <f:RadioButtonList ID="RadioButtonList1" Required="true" runat="server">
                ...
                <f:HyperLinkField ColumnID="Major" HeaderText="所学专业" DataToolTipField="Major" DataTextField="Major"
                    ...
                    UrlEncode="true" Target="_blank" ExpandUnusedSpace="True" EnableFilter="true">
                    <Filter>
                        <Field>
                            <f:CheckBoxList ColumnNumber="1" Required="true" runat="server">
                ...
                <f:ImageField ColumnID="Group" Width="80px" DataImageUrlField="Group" DataImageUrlFormatString="~/res/images/16/{0}.png"
                    ...
                    <Filter>
                        <Field>
                            <f:DropDownList ID="groupList" EnableMultiSelect="true" AutoSelectFirstItem="false" Required="true" runat="server">
                            </f:DropDownList>
                        </Field>
                    </Filter>
                </f:ImageField>
