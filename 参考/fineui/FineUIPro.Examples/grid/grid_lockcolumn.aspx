<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="grid_lockcolumn.aspx.cs" Inherits="FineUIPro.Examples.grid.grid_lockcolumn" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="true" Title="表格" Width="850px" runat="server"
            ...
            <Columns>
                ...
                <f:HyperLinkField ExpandUnusedSpace="true" EnableLock="true" HeaderText="所学专业" DataToolTipField="Major" DataTextField="Major"
        ...
        <br />
        <br />
        注：本示例中[所学专业]是自动扩展列，所以初始没有横向滚动条，可以尝试改变列宽度使其出现横向滚动条。
    </form>
</body>
</html>
