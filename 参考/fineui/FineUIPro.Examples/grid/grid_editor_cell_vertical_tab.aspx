<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="grid_editor_cell_vertical_tab.aspx.cs"
    Inherits="FineUIPro.Examples.grid.grid_editor_cell_vertical_tab" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="true" Title="表格（单击编辑）" EnableCollapse="true" Width="850px"
            ...
            AllowCellEditing="true" ShowSelectedCell="true" ClicksToEdit="1" TabVerticalNavigate="true">
            <Columns>
