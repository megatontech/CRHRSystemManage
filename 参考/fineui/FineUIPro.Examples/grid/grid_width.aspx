<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="grid_width.aspx.cs" Inherits="FineUIPro.Examples.grid.grid_width" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="true" Title="表格(改变页面大小来观察每列宽度的变化)"
            ...
            <Columns>
                ...
                <f:HyperLinkField Width="200px" HeaderText="所学专业" DataToolTipField="Major" DataTextField="Major"
