...
namespace FrameWork.Components
{
    ...
    public class sys_FrameWorkInfoTable
    {
        ...
        private string _S_Name = "用户管理后台系统";
        private string _S_Version = "1.0";
        ...
        private string _S_RegsionUrl = "http://www.baidu.com/";
        private string _S_UpdateUrl = "http://www.baidu.com";
        //private string _S_UpdateUrl = "http://localhost:1404/FrameWork.Service.Web/UpdateFrameWork.aspx";
        private string _S_CheckLicensed = "http://www.baidu.com";
        #endregion
