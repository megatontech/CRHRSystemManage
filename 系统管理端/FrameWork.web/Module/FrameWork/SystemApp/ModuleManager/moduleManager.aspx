<%@ Page Language="C#" MasterPageFile="~/MasterPage/PageTemplate.Master" AutoEventWireup="true" CodeBehind="moduleManager.aspx.cs" Inherits="FrameWork.web.Module.FrameWork.ModuleManager.moduleManager"  %>
          ...
          <tr class="table_none">
            <td align="center">
                ...
                <tr>
                    ...
                    <td>
                       	<img border="0" src="<%=Page.ResolveUrl("~/") %>images/up01.gif" OnClick="javascript:moveUpDown('up','<%=OrderByListItems_UniqueID %>');" style="cursor:pointer;">
    			        <p><img border="0" src="<%=Page.ResolveUrl("~/") %>images/down01.gif" OnClick="javascript:moveUpDown('down','<%=OrderByListItems_UniqueID %>');" style="cursor:pointer;">
                    </td>
                </tr>
                </table>
