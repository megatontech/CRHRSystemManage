...
namespace FineOA.BLL
{
	...
	public partial class t_Role
	{
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public FineOA.Model.t_Role GetModelByCache(int FRoleId)
		{
			
			string CacheKey = "t_RoleModel-" + FRoleId;
			...
			return (FineOA.Model.t_Role)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<FineOA.Model.t_Role> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<FineOA.Model.t_Role> DataTableToList(DataTable dt)
		{
			List<FineOA.Model.t_Role> modelList = new List<FineOA.Model.t_Role>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				FineOA.Model.t_Role model;
