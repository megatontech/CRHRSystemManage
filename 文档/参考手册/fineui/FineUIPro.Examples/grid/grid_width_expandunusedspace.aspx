<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="grid_width_expandunusedspace.aspx.cs"
    Inherits="FineUIPro.Examples.grid.grid_width_expandunusedspace" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="true" Title="表格（ExpandUnusedSpace）(改变页面大小来观察每列宽度的变化)"
