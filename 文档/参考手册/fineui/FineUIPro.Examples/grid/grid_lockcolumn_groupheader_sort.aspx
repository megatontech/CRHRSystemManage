<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="grid_lockcolumn_groupheader_sort.aspx.cs"
    Inherits="FineUIPro.Examples.grid.grid_lockcolumn_groupheader_sort" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="true" Title="表格" EnableCollapse="true" Width="800px" runat="server"
            DataKeyNames="Id" AllowSorting="true" SortField="HZData1" AllowColumnLocking="true"
            SortDirection="ASC" OnSort="Grid1_Sort">
            <Columns>
                <f:RowNumberField />
                <f:BoundField DataField="Year" EnableLock="true" Locked="true" Width="80px" HeaderText="统计年份" />
                <f:GroupField EnableLock="true" HeaderText="安徽省" TextAlign="Center">
                    <Columns>
                        <f:GroupField EnableLock="true" Locked="true" HeaderText="合肥市" TextAlign="Center">
                            <Columns>
                                <f:BoundField EnableLock="true" Locked="true" Width="80px" DataField="AHData1" SortField="AHData1" HeaderText="数据一"
                                    TextAlign="Center" />
                                <f:BoundField EnableLock="true" Width="80px" DataField="AHData2" SortField="AHData2" HeaderText="数据二"
                                    TextAlign="Center" />
                            </Columns>
                        </f:GroupField>
                    </Columns>
