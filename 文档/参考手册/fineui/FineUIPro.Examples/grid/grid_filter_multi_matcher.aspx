<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="grid_filter_multi_matcher.aspx.cs" Inherits="FineUIPro.Examples.grid.grid_filter_multi_matcher" %>
        ...
        <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="true" Title="表格" Width="800px" runat="server" EnableCollapse="true"
            ...
            <Columns>
                ...
                <f:BoundField ColumnID="Name" Width="100px" DataField="Name" DataFormatString="{0}" HeaderText="姓名" EnableFilter="true">
                    <Filter EnableMultiFilter="true" ShowMatcher="true" MatcherDefault="any">
                        <Operator>
                ...
                <f:BoundField ColumnID="EntranceYear" Width="80px" DataField="EntranceYear" HeaderText="入学年份" />
