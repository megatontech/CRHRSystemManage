<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="grid_lockcolumn_editor_cell_new.aspx.cs"
    Inherits="FineUIPro.Examples.grid.grid_lockcolumn_editor_cell_new" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="true" Title="表格" EnableCollapse="true" Width="850px"
            runat="server" DataKeyNames="Id,Name" AllowColumnLocking="true" AllowCellEditing="true" ShowSelectedCell="true" ClicksToEdit="2">
            <Toolbars>
