<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="grid_checkboxfield_rowcheckall_clientside.aspx.cs"
    Inherits="FineUIPro.Examples.grid.grid_checkboxfield_rowcheckall_clientside" %>
    ...
    <script>
        ...
        function onSelectRows() {
            ...
            if (selectedRows.length) {
                selectedRows.find('.f-grid-checkbox').addClass('checked');
            } else {
                alert("请至少选择一项！");
            }
        }
        ...
        function onUnselectRows() {
            var selectedRows = $('.f-grid-row-selected');
            if (selectedRows.length) {
                selectedRows.find('.f-grid-checkbox').removeClass('checked');
            } else {
                alert("请至少选择一项！");
            }
        }
