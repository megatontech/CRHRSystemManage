...
namespace FineUIPro.Examples.form
{
    public partial class radiobuttonlist_update : PageBase
    {
        ...
        {
            Notify("列表一选中项的值：" + GetCheckedValuesString(RadioButtonList1.SelectedValue));
        }
        ...
        {
            Notify("列表二选中项的值：" + GetCheckedValuesString(RadioButtonList2.SelectedValue));
        }
        ...
        {
            Notify("列表三选中项的值：" + GetCheckedValuesString(RadioButtonList3.SelectedValue));
        }
        ...
        {
            Notify("列表四选中项的值：" + GetCheckedValuesString(RadioButtonList4.SelectedValue));
        }
