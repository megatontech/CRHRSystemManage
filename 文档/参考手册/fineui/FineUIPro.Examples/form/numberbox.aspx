<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="numberbox.aspx.cs" Inherits="FineUIPro.Examples.form.numberbox" %>
        ...
        <f:SimpleForm ID="SimpleForm1" BodyPadding="5px" Width="550px" LabelAlign="Top" EnableCollapse="true"
            ...
            <Items>
                ...
                <f:NumberBox ID="NumberBox4" runat="server" EmptyText="精度为 3，比如 0.356" Label="0 到 1 之间的小数"
                    MaxValue="1" MinValue="0" NoNegative="True" DecimalPrecision="3" Required="True" ShowRedStar="True">
                </f:NumberBox>
