<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="form_compare.aspx.cs" Inherits="FineUIPro.Examples.form.form_compare" %>
...
<body>
    ...
    <f:SimpleForm ID="SimpleForm1" BodyPadding="5px" Width="600px" LabelWidth="200px"  EnableCollapse="true"
        ...
        <Items>
            ...
            <f:TextBox ID="TextBox1" Required="true" Label="文本框 1" Text="FineUIPro" runat="server">
            </f:TextBox>
