<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="vbox.aspx.cs" Inherits="FineUIPro.Examples.layout.vbox" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Panel ID="Panel2" runat="server" Height="350px" Width="850px" ShowBorder="True" EnableCollapse="true"
            Layout="VBox" BoxConfigAlign="Stretch" BoxConfigPosition="Start" BodyPadding="5px"
            BoxConfigChildMargin="0 0 5 0" ShowHeader="True" Title="面板（Layout=VBox BoxConfigAlign=Stretch BoxConfigPosition=Start BoxConfigChildMargin=0 0 5 0）">
            <Items>
        ...
        <f:Panel ID="Panel5" runat="server" Height="350px" Width="850px" ShowBorder="True" EnableCollapse="true"
            Layout="VBox" BoxConfigAlign="Stretch" BoxConfigPosition="End" BodyPadding="5px"
            BoxConfigChildMargin="0 0 5 0" ShowHeader="True" Title="面板（Layout=VBox BoxConfigAlign=Stretch BoxConfigPosition=End BoxConfigChildMargin=0 0 5 0）">
            <Items>
        ...
        <f:Panel ID="Panel9" runat="server" Height="350px" Width="850px" ShowBorder="True" EnableCollapse="true"
            Layout="VBox" BoxConfigAlign="Stretch" BoxConfigPosition="Center" BodyPadding="5px"
            BoxConfigChildMargin="0 0 5 0" ShowHeader="True" Title="面板（Layout=VBox BoxConfigAlign=Stretch BoxConfigPosition=Center BoxConfigChildMargin=0 0 5 0）">
            <Items>
        ...
        <f:Panel ID="Panel13" runat="server" Height="350px" Width="850px" ShowBorder="True" EnableCollapse="true"
            Layout="VBox" BoxConfigAlign="Start" BoxConfigPosition="Center" BodyPadding="5px"
            BoxConfigChildMargin="0 0 5 0" ShowHeader="True" Title="面板（Layout=VBox BoxConfigAlign=Start BoxConfigPosition=Center BoxConfigChildMargin=0 0 5 0）">
            <Items>
                ...
                <f:Panel ID="Panel16" Title="面板3" Width="600px" Margin="0"
                    Height="60px" runat="server" BodyPadding="5px" ShowBorder="true" ShowHeader="false">
                    <Items>
        ...
        <f:Panel ID="Panel21" runat="server" Height="350px" Width="850px" ShowBorder="True" EnableCollapse="true"
            Layout="VBox" BoxConfigAlign="Center" BoxConfigPosition="End" BodyPadding="5px"
            BoxConfigChildMargin="0 0 5 0" ShowHeader="True" Title="面板（Layout=VBox BoxConfigAlign=Center BoxConfigPosition=End BoxConfigChildMargin=0 0 5 0）">
            <Items>
        ...
        <br />
        <br />
        <f:Panel ID="Panel25" runat="server" Height="350px" Width="850px" ShowBorder="True" EnableCollapse="true"
            Layout="VBox" BoxConfigAlign="End" BoxConfigPosition="Center" BodyPadding="5px"
            BoxConfigChildMargin="0 0 5 0" ShowHeader="True" Title="面板（Layout=VBox BoxConfigAlign=End BoxConfigPosition=Center BoxConfigChildMargin=0 0 5 0）">
            <Items>
        ...
        <f:Panel ID="Panel17" runat="server" Height="350px" Width="850px" ShowBorder="True" EnableCollapse="true"
            Layout="VBox" BoxConfigAlign="StretchMax" BoxConfigPosition="Center" BodyPadding="5px"
            BoxConfigChildMargin="0 0 5 0" ShowHeader="True" Title="面板（Layout=VBox BoxConfigAlign=StretchMax BoxConfigPosition=Center BoxConfigChildMargin=0 0 5 0）">
            <Items>
