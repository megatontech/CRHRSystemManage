<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="grid_iframe.aspx.cs" Inherits="FineUIPro.Examples.iframe.grid_iframe" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Panel ID="Panel7" runat="server" Margin="5px" BodyPadding="5px"
            Title="Panel" ShowBorder="true" ShowHeader="True" Layout="VBox" BoxConfigAlign="Stretch">
            <Items>
