<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="tree_select.aspx.cs" Inherits="FineUIPro.Examples.tree.select.tree_select" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Tree ID="Tree1" Width="550px" EnableCollapse="true" ShowHeader="true" Title="树控件" runat="server">
            <Nodes>
