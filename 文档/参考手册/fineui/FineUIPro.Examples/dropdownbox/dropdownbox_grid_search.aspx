<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="dropdownbox_grid_search.aspx.cs" Inherits="FineUIPro.Examples.dropdownbox.dropdownbox_grid_search" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:SimpleForm ID="SimpleForm1" BodyPadding="5px" runat="server" Width="400px" EnableCollapse="true"
            ShowBorder="True" Title="下拉表格（在表格中查找）" ShowHeader="True">
            <Items>
