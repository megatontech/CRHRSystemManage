...
namespace FineOA.SQLServerDAL
{
	...
	public partial class t_Menu:It_Menu
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("FParentId", "t_Menu"); 
		}
		...
		public bool Exists(int FParentId,int FViewPowerId,int FItemId)
		{
			...
			SqlParameter[] parameters = {
					...
					new SqlParameter("@FViewPowerId", SqlDbType.Int,4),
		...
		public int Add(FineOA.Model.t_Menu model)
		{
			...
			SqlParameter[] parameters = {
					...
					new SqlParameter("@FImageUrl", SqlDbType.NVarChar,200),
					new SqlParameter("@FNavigateUrl", SqlDbType.NVarChar,200),
					new SqlParameter("@FDescription", SqlDbType.NVarChar,500),
					new SqlParameter("@FSortIndex", SqlDbType.Int,4),
					new SqlParameter("@FParentId", SqlDbType.Int,4),
					new SqlParameter("@FViewPowerId", SqlDbType.Int,4)};
