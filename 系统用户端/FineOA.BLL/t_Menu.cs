...
namespace FineOA.BLL
{
	...
	{
		private readonly It_Menu dal=DataAccess.Createt_Menu();
		public t_Menu()
		{}
		#region  BasicMethod
		...
		{
			return dal.Exists(FParentId,FViewPowerId,FItemId);
		}
		...
		public bool Delete(int FParentId,int FViewPowerId,int FItemId)
		{
			...
			return dal.Delete(FParentId,FViewPowerId,FItemId);
		}
		/// <summary>
		/// 删除一条数据
		/// </summary>
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public FineOA.Model.t_Menu GetModelByCache(int FItemId)
		{
			
			string CacheKey = "t_MenuModel-" + FItemId;
			...
			return (FineOA.Model.t_Menu)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<FineOA.Model.t_Menu> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<FineOA.Model.t_Menu> DataTableToList(DataTable dt)
		{
			List<FineOA.Model.t_Menu> modelList = new List<FineOA.Model.t_Menu>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				FineOA.Model.t_Menu model;
