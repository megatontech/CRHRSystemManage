...
namespace FineOA.MysqlDAL
{
	...
	public partial class t_Log:It_Log
	{
		...
		public int GetMaxId()
		{
		return DbHelperMysql.GetMaxID("FItemId", "t_Log"); 
		}
		...
		public int Add(FineOA.Model.t_Log model)
		{
			...
			MySqlParameter[] parameters = {
					new MySqlParameter("@FLevel", MySqlDbType.String,20),
					new MySqlParameter("@FLogger", MySqlDbType.String,200),
					new MySqlParameter("@FMessage", MySqlDbType.String,4000),
					new MySqlParameter("@FException", MySqlDbType.String,4000),
					new MySqlParameter("@FLogTime", MySqlDbType.DateTime)};
